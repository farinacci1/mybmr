...
public class NativeAdFactory  implements GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    public NativeAdView createNativeAd(NativeAd nativeAd, Map<String, Object> customOptions) {
        NativeAdView adView = (NativeAdView) layoutInflater.inflate(R.layout.ad_card, null);
        ...
        if (nativeAd.getBody() == null) {
           ...
           TextView bodyTextView = ((TextView) adView.getBodyView());
        ...
        if (nativeAd.getCallToAction() == null) {
            ...
            Button actionButton = ((Button) adView.getCallToActionView());
